...
def _parse_args():
    ...
    parser.add_argument('--sync_logs',default=False,action="store_true")# the log will be send to imitator server /out_debug, configs are in rla_config.yml
    parser.add_argument("--device", default="cuda:0", type=str)
    parser.add_argument("--debug", default=False, action="store_true")
    parser.add_argument("--seed",default=0,type=int)
    parser.add_argument("--description", default="default-exp-info", type=str, help="Make a detailed description about your experiment")

    
    # experiment setting config
    parser.add_argument('--multi_map',default=False,action='store_true')
    parser.add_argument('--obstacle_prob',default=0.0,type=float)
    parser.add_argument('--no_coordinate',default=False,action='store_true')
    parser.add_argument('--reward_fun_type',default='origin',type=str)
    # parser.add_argument("--algo",default='DDT',type=str) # algo shortcut flag
...
def get_alg_args(config_file):
    ...
    # elif configs['algo']=='CbMRL':
    #     configs['baseline']=True
    #     configs['add_bc_reward']=False
    #     configs['use_rnn_actor']=True
