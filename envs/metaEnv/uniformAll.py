...
from .utils import convert_space
...
class MetaEnvUniform(gym.Env):
    def __init__(self,  reward_type="dense"):
        ...
        try:
            ...
            pass
            # print(f"Cannot load shelf-place-v2: {e}")

        self.task = None
        self.state_dim = 39
        self.observation_space = convert_space(self.model_dict['pick-place-v2'].observation_space)
        self.action_space = convert_space(self.model_dict['pick-place-v2'].action_space)
