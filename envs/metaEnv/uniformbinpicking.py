...
class MetaEnvBinPicking(gym.Env):
    def __init__(self,  reward_type="dense"):
        super(MetaEnvBinPicking, self).__init__()

        self.model = SawyerBinPickingEnvV2()
        self.task = None
        self.state_dim = 39
    ...
    def reset(self, init_state = None, goal = None, traj_for_env = None, apply_noise = False, reset_with_noise = False, task = None):
